            ...
            <Card bordered>
              <div className={styles.divStyle}>
                ...
                <ul>
                  ...
                  <li>
                    If no, then respond with “There are no regulatory concerns”
                ...
                <h2>Prompt 4</h2>
                <p>For each solution that is proposed do the following:</p>
                <ol type="1">
                  <li>
                  ...
                  <li>
                    In addition to the succinct and compelling description, for
                    each solution provide a comprehensive description that
